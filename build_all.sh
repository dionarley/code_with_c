...
g++ -O3 -pthread stress_pi.cpp pi_lib.cpp -o stress_pi

# Build stress_pi_test
echo "Building stress_pi_test..."
g++ -O3 -pthread -I. stress_pi_test.cpp pi_lib.cpp -o stress_pi_test

# Build stress_pi_progress
echo "Building stress_pi_progress..."
g++ -O3 -pthread stress_pi_progress.cpp -o stress_pi_progress
...
echo
echo "Binaries:"
ls -lh stress_pi stress_pi_test stress_pi_progress stress_pi_v2 2>/dev/null || true